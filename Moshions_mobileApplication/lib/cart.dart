...
class _CartListState extends State<CartList> {
  ...
  final List<Map<dynamic, dynamic>> products = [
    {'name': 'Shirt', 'rating': 3.0, 'image': 'https://moshions.rw/wp-content/uploads/elementor/thumbs/Screen-Shot-2020-02-11-at-17.09.26-olotd5ef9f4v5y4t66e9rrmv5rdjjbw3ybo58ostim.png', 'price': '200'},
    {'name': 'Umushanana', 'rating': 3.0, 'image': 'https://moshions.rw/wp-content/uploads/2017/11/DSC6550.jpg', 'price': '200'},
    {'name': 'Legging', 'rating': 4.0, 'image': 'https://moshions.rw/wp-content/uploads/2017/11/DSC6550.jpg', 'price': '200'},
        ...
        body: Column(
          children: <Widget>[
            Padding(
              ...
              child: Container(
                  child: Text(products.length.toString() + " ITEMS IN YOUR BAG", textDirection: TextDirection.ltr, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold))
              ),
            ),
            Flexible(
            ...
            Padding(
              ...
              child: Container(
                ...
                child:ButtonTheme(
                buttonColor: Color.fromRGBO(255, 165, 16, 1),
